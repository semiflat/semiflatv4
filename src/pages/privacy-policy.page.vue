...
<template>
  <div class="relative page-content">
    ...
    <div class="mt-3.5rem md:mt-40 md:text-center">
      <h1 class="hero-title md:text-[2.5rem] font-semibold md:leading-[120%] md:mt-6">
        Our privacy policy_
      </h1>
      <p class="mt-6 text-blue-200">How Semiflat handles and collect user data.</p>
    </div>
    <div class="mt-16 md:mt-40 max-w-[45.375rem] mx-auto">
      <h2 class="gradient-text font-semibold text-[1.25rem]">Introduction</h2>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <p class="mt-8 leading-150% text-blue-200">
        ...
        Privacy Policy Template and the Privacy Policy Generator.
      </p>
      <p class="mt-8 leading-150% text-blue-200">
        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
        which is accessible at www.site.com, unless otherwise defined in this Privacy Policy.
      </p>
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Information collection and use</h2>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Log data</h2>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Cookies</h2>
      <p class="mt-8 leading-150% text-blue-200">
        ...
        may not be able to use some portions of our Service. For more general information on
        cookies, please read "What Are Cookies".
      </p>
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Service providers</h2>
      <p class="mt-8 leading-150% text-blue-200">
        We may employ third-party companies and individuals due to the following reasons:
      </p>

      <ul class="mt-8 leading-150% text-blue-200">
        <li>— Tofacilitate our Service;</li>
        <li>— To provide the Service on our behalf;</li>
        <li>— To perform Service-related</li>
      </ul>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Security</h2>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Links to other sites</h2>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Children's privacy</h2>
      <p class="mt-8 leading-150% text-blue-200">
      ...
      <div class="h-[1px] w-full bg-[#BCDCDC] my-16" />
      <h2 class="gradient-text font-semibold text-[1.25rem]">Changes to this Privacy Policy</h2>
      <p class="mt-8 leading-150% text-blue-200">
