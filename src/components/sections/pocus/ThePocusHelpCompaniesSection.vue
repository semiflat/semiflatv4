...
import Feature1Img from '~/assets/pocus/feature-1.svg?url'
import Feature2Img from '~/assets/pocus/feature-2.svg?url'
import Feature3Img from '~/assets/pocus/feature-3.svg?url'
