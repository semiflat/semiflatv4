  ...
  <div class="page-content mt-16 md:mt-40">
    <div class="md:grid grid-cols-2 md:max-w-[57.125rem] mx-auto ">
      <div class="md:max-w-[21.625rem]">
        ...
        <p class="mt-4 text-[#545959]">What did Useful gain from working with us? Where is the project now?</p>
      </div>
      <div class="mt-8 grid gap-8 md:mt-0">
        <div class="flex gap-6">
          <div class="md:pr-2">
            <p class="text-[#545959] mb-8">Over two months, we’ve delivered a complete user experience and a clickable
              application prototype. We wanted to make sure that Useful is set up for success, so we’ve also implemented
              a design system containing all of the components used across the interface.</p>
            <p class="text-[#545959] mb-8 md:mb-12">Useful went on to raise a $5M financing round from Spark Capital and
              Unusual Ventures. The application is currently in the last stages of development, serving first users
              through an early-access program.</p>
            <div class="p-8 bg-violet-gradient text-white rounded-4 relative md:p-10">
              <h3 class="font-semibold mb-1 leading-[150%]">Have a project in mind similar to Useful?</h3>
              <p class="mb-8 md:pr-8 leading-[150%]">Ask us about a fixed-scope MVP sprint and how we can create an
                interactive prototype to help you tell the story of your product.</p>
    ...
    <div class="md:grid grid-cols-2 md:max-w-[57.125rem] mx-auto ">
      <div class="md:max-w-[21.562rem]">
        ...
        <p class="mt-4 text-[#545959]">What are the tangible deliverables Useful received from us during the
          collaboration?</p>
      </div>
      <div class="mt-8 grid gap-8 md:mt-0">
...
<style>
.bg-violet-gradient {
  background: radial-gradient(57.03% 76.98% at 100% 0%, rgba(255, 255, 255, 0.8) 0%, rgba(255, 255, 255, 0) 100%) /* warning: gradient uses a rotation that is not supported by CSS and may not behave as expected */, linear-gradient(0deg, rgba(0, 0, 0, 0.48), rgba(0, 0, 0, 0.48)), #481B97;
