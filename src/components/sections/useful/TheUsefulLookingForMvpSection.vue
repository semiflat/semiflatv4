  ...
  <div class="page-content mt-16 md:mt-40">
    ...
    >
      <div class="absolute pointer-events-none w-full h-full opacity-70 top-0 left-0 z-1 card-mask">
        ...
        <img :src="LeftBg" class="absolute bottom-3 left-0 md:w-[250px] md:h-[250px]" />
      </div>
      <div class="md:max-w-[33.5rem] md:mx-auto md:text-center">
        ...
        <p class="mb-10">
          Reach out with more details about your project so we can prepare for an introductory call.
          We’ll schedule it within 24 hours from receiving your query.
        </p>
        <AppButton secondary href="mailto:hello@semiflat.com">Get in touch</AppButton>
        <AppButton
          class="!text-white"
          text
          target="_blank"
