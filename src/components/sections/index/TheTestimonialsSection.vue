...
.rotating-border {
    width: 100%;
    background: linear-gradient(90deg, #BCDCDC 50%, transparent 50%), linear-gradient(90deg, #BCDCDC 50%, transparent 50%), linear-gradient(0deg, #BCDCDC 50%, transparent 50%), linear-gradient(0deg, #BCDCDC 50%, transparent 50%);
