...
import Asset from '~/assets/work/ground-up-design-overview-bg.svg'
</script>

<template>
  <div class="bg">
    <div class="bg__vertical-rocket"></div>
    <component :is="Asset" />
  </div>
</template>
...
.bg {
  ...
  &::after {
    ...
    z-index: 1;
    border-radius: 2px;
    background: linear-gradient(270deg, #54aba3 0%, rgba(84, 171, 163, 0) 100%);
  }
